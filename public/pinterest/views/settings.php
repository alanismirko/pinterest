...
<section class="profile-container">
    ...
    <div class="profile-edit-wrapper">
        ...
        <div class="category-edit">
            <ul>
                <li><a href="/<?php echo $user_nickname ?>/edit-profile">Public profile</a></li>
                <li><a href="/<?php echo $user_nickname ?>/account-settings">Account management</a></li>
        ...
        <?php
            ...
            <div class="profile-edit">
                ...
                <form action="/update-profile" method="POST">
                    ...
                    <input type="text" name="user_nickname" value="<?php echo $user_nickname ?>">
